      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            >
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-600 to-teal-500 flex items-center justify-center shadow-md shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-shadow">
                <span className="text-white font-black text-base">N</span>
              </div>
              <span className="text-lg font-extrabold text-[#0F172A] dark:text-white tracking-tight">
                NextGen<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500"> Tech</span>
              </span>
            </button>
